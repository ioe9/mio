...
class Mage_Core_Model_Resource_Iterator extends Varien_Object
{
     ...
     *
     * @param Varien_Db_Statement_Interface|Varien_Db_Select|string $query
    ...
    /**
     * Fetch Varien statement instance
     *
     * @param Varien_Db_Statement_Interface|Varien_Db_Select|string $query
     * @param Varien_Db_Adapter_Abstract $conn
     * @return Varien_Db_Statement_Interface
     * @throws Mage_Core_Exception
     */
    protected function _getStatement($query, $conn = null)
    {
        if ($query instanceof Varien_Db_Statement_Interface) {
            return $query;
        }
