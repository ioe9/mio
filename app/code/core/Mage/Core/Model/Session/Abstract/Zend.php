...
abstract class Mage_Core_Model_Session_Abstract_Zend extends Varien_Object
{
    ...
    public function start()
    {
        ...
        Varien_Session::setOptions($options);
...
/*
        ...
        if ($sessionResource->hasConnection()) {
            Varien_Session::setSaveHandler($sessionResource);
        }
        Varien_Profiler::stop(__METHOD__.'/setHandler');
*/
        Varien_Profiler::start(__METHOD__.'/start');
        Varien_Session::start();
    ...
    {
        if (!Varien_Session::sessionExists()) {
            $this->start();
        }

        Varien_Profiler::start(__METHOD__.'/init');
        $this->_namespace = new Varien_Session_Namespace($namespace, Varien_Session_Namespace::SINGLE_INSTANCE);
    ...
    {
        return Varien_Session::getId();
    }

    public function setSessionId($id=null)
    {
        if (!is_null($id)) {
            Varien_Session::setId($id);
        }
        return $this;
    }
