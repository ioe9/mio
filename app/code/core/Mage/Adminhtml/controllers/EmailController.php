<?php
class Mage_Adminhtml_EmailController extends Mage_Adminhtml_Controller_Action
{
	public function indexAction() {
		$this->loadLayout();
		$this->_setActiveMenu('email');
        $this->_addContent($this->getLayout()->createBlock('ins/adminhtml_email', 'email'));
		$this->renderLayout();
	}
	...
	public function newAction() {
		$this->loadLayout();
		$this->_setActiveMenu('email');
        $this->_addContent($this->getLayout()->createBlock('ins/adminhtml_email_edit', 'email.edit'));
		$this->renderLayout();
	}
