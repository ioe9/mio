...
class Mage_Adminhtml_Catalog_CategoryController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            if (isset($data['category_posts']) &&
                !$category->getPostsReadonly()
            ) {
                $posts = Mage::helper('core/string')->parseQueryStr($data['category_posts']);
    ...
    public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('adminhtml/catalog_category_tab_post', 'category.post.grid')
                ->toHtml()
        );
    }
