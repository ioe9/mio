<?php
class Mage_Adminhtml_Block_Catalog_Event_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('catalog/event/edit/categories.phtml');
    }

    /**
     * Retrieve currently edited event
     *
    ...
    /**
     * Return array with category IDs which the event is assigned to
     *
     * @return array
     */
    ...
    /**
     * Returns array with nodes those are selected (contain current event)
     *
     * @return array
     */
