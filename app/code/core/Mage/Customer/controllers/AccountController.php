...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _getCustomerErrors($customer)
    {
        ...
        if ($customerErrors !== true) {
    		...
    		$customer->setUsername($request->getPost('username'));
    		$customer->setEmail($request->getPost('email'));
    ...
    protected function _welcomeCustomer(Mage_Customer_Model_Customer $customer, $isJustConfirmed = false)
    {
        $this->_getSession()->addSuccess(
            $this->__('Thank you for registering with %s.', Mage::getStoreConfig('general/store_information/name'))
        );
        /*
        $customer->sendNewAccountEmail(
        ...
        $successUrl = $this->_getUrl('', array('_secure' => true));
