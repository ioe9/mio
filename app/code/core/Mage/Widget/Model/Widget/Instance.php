...
class Mage_Widget_Model_Widget_Instance extends Mage_Core_Model_Abstract
{
    ...
    const PRODUCT_LAYOUT_HANDLE            = 'catalog_post_view';
    ...
    protected function _construct()
    {
        ...
        $this->_layoutHandles = array(
            ...
            'all_posts' => self::PRODUCT_LAYOUT_HANDLE,
        ...
        $this->_specificEntitiesLayoutHandles = array(
            ...
            'all_posts' => self::SINGLE_PRODUCT_LAYOUT_HANLDE,
        );
        foreach (Mage_Catalog_Model_Post_Type::getTypes() as $typeId => $type) {
            ...
            $this->_layoutHandles[$typeId . '_posts'] = $layoutHandle;
            $this->_specificEntitiesLayoutHandles[$typeId . '_posts'] = self::SINGLE_PRODUCT_LAYOUT_HANLDE;
        }
    }
