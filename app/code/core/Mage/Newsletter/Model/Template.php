...
class Mage_Newsletter_Model_Template extends Mage_Core_Model_Email_Template_Abstract
{
    ...
    {
        $validators = array(
            'template_code'         => array(Varien_Filter_Input::ALLOW_EMPTY => false),
            'template_type'         => 'Int',
            'template_sender_email' => 'EmailAddress',
            'template_sender_name'  => array(Varien_Filter_Input::ALLOW_EMPTY => false)
        );
        $data = array();
        ...
        $validateInput = new Varien_Filter_Input(array(), $validators, $data);
